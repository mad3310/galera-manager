...
def get_err_msg(api_type):
    msg = {"DBStat": "DBStat gets an error!",
...
class TestDB(unittest.TestCase):
    ...
    def test_db_all_stat(self):
        print "DBStat:  "
        r = requests.get('http: //%s: 8888/db/all/stat' %
                         self.container_ip)
        print r.text
        p = json.loads(r.text)
        code = p["meta"]["code"]
    ...
    def test_db_all_stat_rowsoper_total(self):
        ...
        r = requests.get(
            'http: //%s: 8888/db/all/stat/rowsoper/total' % self.container_ip)
        print r.text
        p = json.loads(r.text)
        code = p["meta"]["code"]
    ...
    def test_db_all_stat_rowsoper_ps(self):
        ...
        r = requests.get(
            'http: //%s: 8888/db/all/stat/rowsoper/ps' % self.container_ip)
        print r.text
        p = json.loads(r.text)
        code = p["meta"]["code"]
    ...
    def test_db_all_stat_innobuffer_memallco(self):
        ...
        r = requests.get(
            'http: //%s: 8888/db/all/stat/innobuffer/memallco' % self.container_ip)
        print r.text
        p = json.loads(r.text)
        code = p["meta"]["code"]
    ...
    def test_db_all_stat_innobuffer_page(self):
        ...
        r = requests.get(
            'http: //%s: 8888/db/all/stat/innobuffer/page' % self.container_ip)
        print r.text
        p = json.loads(r.text)
        code = p["meta"]["code"]
    ...
    def test_db_all_stat_innobuffer_pool(self):
        ...
        r = requests.get(
            'http: //%s: 8888/db/all/stat/innobuffer/pool' % self.container_ip)
        print r.text
        p = json.loads(r.text)
        code = p["meta"]["code"]
    ...
    def test_db_all_stat_variablestatus_ps(self):
        ...
        r = requests.get(
            'http: //%s: 8888/db/all/stat/variablestatus/ps' % self.container_ip)
        print r.text
        p = json.loads(r.text)
        code = p["meta"]["code"]
    ...
    def test_db_all_stat_variablestatus_used(self):
        ...
        r = requests.get(
            'http: //%s: 8888/db/all/stat/variablestatus/used' % self.container_ip)
        print r.text
        p = json.loads(r.text)
        code = p["meta"]["code"]
    ...
    def test_db_all_stat_variablestatus_ration(self):
        ...
        r = requests.get(
            'http: //%s: 8888/db/all/stat/variablestatus/ration' % self.container_ip)
        print r.text
        p = json.loads(r.text)
        code = p["meta"]["code"]
        self.assertEqual(200, code, get_err_msg(
            "StatVariableStatusRation"))

    def test_db_all_stat_wsrepstatus_flow_control_paused(self):
        print "StatWsrepstatusFlowControlPaused:  "
        r = requests.get(
            'http: //%s: 8888/db/all/stat/wsrepstatus/flow_control_paused' % self.container_ip)
        print r.text
        p = json.loads(r.text)
        code = p["meta"]["code"]
        self.assertEqual(200, code, get_err_msg(
    ...
    def test_db_all_stat_wsrepstatus_slowest_node_param(self):
        ...
        r = requests.get(
            'http: //%s: 8888/db/all/stat/wsrepstatus/slowest_node_param' % self.container_ip)
        print r.text
        p = json.loads(r.text)
        code = p["meta"]["code"]
        self.assertEqual(200, code, get_err_msg(
    ...
    def test_db_all_stat_wsrepstatus_slowest_network_param(self):
        ...
        r = requests.get(
            'http: //%s: 8888/db/all/stat/wsrepstatus/slowest_network_param' % self.container_ip)
        print r.text
        p = json.loads(r.text)
        code = p["meta"]["code"]
        self.assertEqual(200, code, get_err_msg(
