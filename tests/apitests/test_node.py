...
class TestRemove(unittest.TestCase):
    ...
    def test_step2(self):
        ...
        global ipAddrr
        r = requests.delete('http://%s:8888/cluster/node' %
    ...
    def test_step3(self):
        payload = dict(containerClusterName=self.clusterName,
                       containerNameList=self.nodeName)
        global ipAddrr
        r = requests.post('http://10.154.156.129:8888/containerCluster/node/remove',
